...
from tap_tester.suites.helpscout.base import BaseTapTest
...
class MinimumSelectionTest(BaseTapTest):
    ...
    def name(self):
        return "tap_tester_helpscout_no_fields_test"
    ...
    def do_test(self, conn_id):
        ...
        untested_streams = self.child_streams().union({'conversations', 'conversation_threads', \
            'customers', 'mailboxes', 'mailbox_fields', 'mailbox_folders', 'users', 'workflows'})
